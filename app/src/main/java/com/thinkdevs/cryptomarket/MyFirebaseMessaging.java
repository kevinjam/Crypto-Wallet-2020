...
public class MyFirebaseMessaging extends FirebaseMessagingService {
    ...
    private static final String PAYOUT_TYPE="com.thinkdevs.cryptomarket.PAYOUT_NOTIFICATION";
    private static final String REFER_TYPE="com.thinkdevs.cryptomarket.REFER_NOTIFICATION";
    private static final String REVIEW_TYPE="com.thinkdevs.cryptomarket.REVIEW_NOTIFICATION";
    int PRIVATE_MODE = 0;
    private static final String PREF_NAME = "cryptomarket_app";
